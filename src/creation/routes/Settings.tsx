    ...
    try {
      ...
      if (screen) {
        ...
        if (se) {
          ...
          if (
            typeof currSettings?.showCurrencies === "undefined" ||
            (currSettings.showCurrencies.length === 0 && typeof se.showCurrencies !== "undefined" && se.showCurrencies.length)
          ) {
      ...
      <SettingsContainer>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <FormGroup>
            ...
            <Checkbox type="checkbox" id="autoAdvances" checked={autoAdvances} onChange={(e) => setAutoAdvances(e.target.checked)} />
          </FormGroup>
          ...
          <FormGroup>
            ...
            <Input type="number" id="timeToAnswer" value={timeToAnswer} onChange={(e) => setTimeToAnswer(Number(e.target.value))} />
          </FormGroup>

          <FormGroup>
            <label htmlFor="defaultBackground">Default Background:</label>
            <Input type="text" id="defaultBackground" value={defaultBackground} onChange={(e) => setDefaultBackground(e.target.value)} />
          </FormGroup>
